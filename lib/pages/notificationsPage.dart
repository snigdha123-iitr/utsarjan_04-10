...
class NotificationsPage extends StatefulWidget {
  ...
  NotificationsPage({this.patientId,this.isFrom});
  @override
...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  void didChangeDependencies() {
    ...
    setState(() {
      ...
      if(widget.isFrom==AppLocalizations.of(context).notifications) {
        getAllNotifications(patientId).then((notify) {
          setState(() {
            print("00000000000000000000000000000000000000");

            print("000000000000000000123, Notification");

            notificationsList = notify;
            print(notificationsListToJson(notificationsList));

            /*for (int i = 0; i < notificationsList.length; i++) {
              print(notificationsList[i].notification);
            }*/
        ...
        getTestNotifications(patientId,true).then((notify) {
          setState(() {
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              notifications.photo != ''
                ...
                _showImage(context, notifications.photo);
              },child: Image.network(notifications.photo.contains("public") ? serverIP + '/' + notifications.photo : serverIP + '/public/' + notifications.photo))
                  : Text(notifications.medicationDetail != null ? setMedicineDetails(notifications.medicationDetail) : notifications.tests != "" ? getTestText(notifications.tests) : notifications.notification != null ? "\n"+notifications.notification : "",
        ...
        body: (notificationsList == null)
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, i) {
                  ...
                  //     //padding: EdgeInsets.only(bottom: 50.0, top: 10, left: 5, right: 5),
                  //     // child: Card(
                  //     //     child: Padding(
                  //     //   padding: const EdgeInsets.all(20.0),
                  //     //   child: Column(
                  ...
                  // return listItem(notifications[i]);
                }));
  }
}
